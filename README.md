...
### 🧬 Scientific — CRISPR-Cas9 奠基论文 (科研范式)

> **知识高密度科研案例**：Figure 编号 · 语义生物学色 · 引用 · 无动画
> 完整案例（PPT + build.py + 论文说明）见 [`showcase/crispr-cas9-2012/`](showcase/crispr-cas9-2012/README.md)

| 页面元素 | 科研范式实现 |
|---------|-------------|
| **凝胶电泳** | 6 泳道 rect 模拟，双 RNA 条件出现切割条带 |
| **切割效率** | 原生柱状图（双 RNA 95% vs 单 RNA 15%） |
| **PAM 序列比对** | Consolas 等宽字体 + 语义色标记 NGG/NAG/NGA |
| **机制图** | RuvC + HNH 双结构域 + 双链 DNA 切割位点 |
